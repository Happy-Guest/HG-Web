...
export const gradientBgBlueGray = `${gradientBgBase} from-stone-800 via-slate-700 to-gray-600`;
export const gradientBgDark = `${gradientBgBase} from-slate-700 via-slate-800 to-slate-900`;
export const gradientBgPinkRed = `${gradientBgBase} from-pink-400 via-red-500 to-yellow-600`;
...
export const getButtonColor = (
    ...
    const colors = {
        ...
        bg: {
            ...
            warning: "bg-yellow-600 dark:bg-yellow-600 text-white",
        ...
        bgHover: {
            ...
            warning:
                "hover:bg-yellow-700 hover:border-yellow-700 hover:dark:bg-yellow-700 hover:dark:border-yellow-700",
