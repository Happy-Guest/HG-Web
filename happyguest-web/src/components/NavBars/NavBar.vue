...
<template>
    <nav
        class="top-0 inset-x-0 fixed bg-gray-50 h-16 z-30 transition-position w-screen lg:w-auto dark:bg-slate-800 shadow-md"
    >
        <div class="flex lg:items-stretch mt-1" :class="containerMaxW">
